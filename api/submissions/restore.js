...
export default async function handler(req, res) {
    ...
    try {
        ...
        try {
            ...
            console.warn('Could not reset submissions sequence via pg_get_serial_sequence:', seqErr.message)
            try {
        ...
        try {
            ...
            console.warn('Could not reset files sequence via pg_get_serial_sequence:', seqErr.message)
            try {
